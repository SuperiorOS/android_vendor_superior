...
PRODUCT_COPY_FILES += \
    ...
    vendor/superior/config/permissions/superior-hiddenapi-package-whitelist.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/permissions/superior-hiddenapi-package-whitelist.xml
