# Copyright (C) 2018-2019 The superiorOS Project
#
...
KERNEL_TOOLCHAIN_ARM32_PREFIX ?= $(KERNEL_TOOLCHAIN_PREFIX_$(KERNEL_ARCH))
endif
...
KERNEL_MAKE_FLAGS += -j$(shell prebuilts/tools-superior/$(HOST_PREBUILT_TAG)/bin/nproc --all)
...
KERNEL_MAKE_FLAGS += DTC_EXT=$(BUILD_TOP)/$(HOST_OUT_EXECUTABLES)/dtc$(HOST_EXECUTABLE_SUFFIX)
...
TOOLS_PATH_OVERRIDE := \
    PATH=$(BUILD_TOP)/prebuilts/tools-superior/$(HOST_PREBUILT_TAG)/bin:$$PATH \
    LD_LIBRARY_PATH=$(BUILD_TOP)/prebuilts/tools-superior/$(HOST_PREBUILT_TAG)/lib:$$LD_LIBRARY_PATH \
    PERL5LIB=$(BUILD_TOP)/prebuilts/tools-superior/common/perl-base
