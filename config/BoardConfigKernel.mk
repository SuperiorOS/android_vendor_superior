# Copyright (C) 2018-2022 The superiorOS Project
#
...
ifeq (,$(filter 5.10, $(TARGET_KERNEL_VERSION)))
    ...
    TOOLS_PATH_OVERRIDE += PATH=$(BUILD_TOP)/prebuilts/tools-superior/$(HOST_PREBUILT_TAG)/bin:$(TARGET_KERNEL_CLANG_PATH)/bin:$$PATH
endif
