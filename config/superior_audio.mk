#
# Superior Audio Files
#

ALARM_PATH := vendor/superior/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/superior/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/superior/prebuilt/common/media/audio/ringtones
