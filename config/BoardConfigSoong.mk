...
SOONG_CONFIG_superiorGlobalVars_camera_needs_client_info_lib_oplus := $(TARGET_CAMERA_NEEDS_CLIENT_INFO_LIB_OPLUS)
...
SOONG_CONFIG_superiorGlobalVars_include_miui_camera := $(TARGET_INCLUDES_MIUI_CAMERA)
...
SOONG_CONFIG_superiorQcomVars_no_fm_firmware := $(TARGET_QCOM_NO_FM_FIRMWARE)
SOONG_CONFIG_superiorQcomVars_qti_vibrator_use_effect_stream := $(TARGET_QTI_VIBRATOR_USE_EFFECT_STREAM)
...
SOONG_CONFIG_superiorGlobalVars_target_alternative_futex_waiters := $(TARGET_ALTERNATIVE_FUTEX_WAITERS)
...
SOONG_CONFIG_superiorGlobalVars_target_power_libperfmgr_mode_extension_lib := $(TARGET_POWER_LIBPERFMGR_MODE_EXTENSION_LIB)
SOONG_CONFIG_superiorGlobalVars_target_powershare_path := $(TARGET_POWERSHARE_PATH)
...
SOONG_CONFIG_superiorQcomVars_qti_vibrator_effect_lib := $(TARGET_QTI_VIBRATOR_EFFECT_LIB)
